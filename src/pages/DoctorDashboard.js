...
export default function DoctorDashboard() {
  ...
  return (
    <div style={{display:"flex",minHeight:"100vh",fontFamily:"Inter,system-ui,sans-serif",background:T.bg}}>
      ...
      {/* SIDEBAR */}
      <div style={{width:sidebarOpen?230:64,background:`linear-gradient(180deg,${T.primaryDark},#0a3d52)`,
        display:"flex",flexDirection:"column",flexShrink:0,transition:"width 0.25s",overflow:"hidden",
