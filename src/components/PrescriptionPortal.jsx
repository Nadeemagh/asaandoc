...
export default function PrescriptionPortal({ doctor: propDoctor, patients: propPatients, doctorId: propDoctorId }) {
  ...
  // Fallback mock data so the component works standalone too
  const doctor   = propDoctor   || { name:"Dr. Ahmed Raza", specialty:"General Physician & Internal Medicine", qualification:"MBBS, FCPS (Medicine)", license:"PMC-12345", hospital:"AsaanDoc Medical Centre", address:"Main Boulevard, Gulberg III, Lahore", phone:"+92 300 1234567" };
  ...
  const doctorId = propDoctorId || "demo-doctor-id";
